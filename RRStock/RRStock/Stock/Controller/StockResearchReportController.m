//
//  StockResearchReportController.m
//  RRCP
//
...
@interface StockResearchReportController ()

@property (nonatomic, assign) BOOL canScroll;

@end

@implementation StockResearchReportController
